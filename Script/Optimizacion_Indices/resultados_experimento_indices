...
```
Se pueden ver estas tablas y sus estructuras <a src="Script/Optimizacion_Indices/scripts_usados/creacion_tabla_indexada.sql">acá</a>.
...
<p align="center">
  <img src="Script/Optimizacion_Indices/imgs/prueba1_plan_conindice.png" alt="Plan de ejecucion para la consulta sobre la tabla con indices" width="160"/>
</p>
...
<p align="center">
  <img src="Script/Optimizacion_Indices/imgs/prueba1_tiempos.png" alt="Estadisticas y tiempos de la prueba con indice vs sin indice" width="160"/>
</p>  
...
- Para la primera consulta:
<p align="center">
  <img src="Script/Optimizacion_Indices/imgs/prueba2_plan_sininclude.png" alt="Plan de ejecucion para la consulta sobre la tabla con indice clustered sin columnas de mas" width="160"/>
</p>
   
- Para la segunda consulta:
<p align="center">
  <img src="Script/Optimizacion_Indices/imgs/prueba2_plan_coninclude.png" alt="Plan de ejecucion para la consulta sobre la tabla con indice clustered con columnas de mas" width="160"/>
</p>
...
Ambas consultas son esencialmente iguales entre sí. Esto queda aun mas en evidencia al ver los tiempos registrados al realizar la consulta:
 ...
 <p align="center">
  <img src="Script/Optimizacion_Indices/imgs/prueba2_tiempos.png" alt="Estadisticas y tiempos de la prueba con con indice clustered con include vs sin include width="160"/>
</p>
